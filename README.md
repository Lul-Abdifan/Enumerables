...
**Enumerable** is a powerful and versatile library that provides a collection of methods to iterate, traverse, and manipulate data structures in Ruby. It extends the functionality of enumerable objects such as arrays, hashes, and ranges, allowing developers to perform common operations with ease and efficiency.
...
- **Perform truthy and falsy actions**
...
```sh
  cd my-folder
  git clone git@github.com:Lul-Abdifan/Enumerables.git
```
### Usage
...
- Twitter: [AbdiBekel](https://twitter.com/AbdiBekele68808)
- LinkedIn: [AbdiBekel](https://www.linkedin.com/in/abdi-bekele-a63860254/)
...
Feel free to check the [issues page](https://github.com/Lul-Abdifan/Enumerables/issues).
...
This project is [MIT](https://github.com/Lul-Abdifan/Enumerables/blob/enumarable/MIT.md) licensed.
